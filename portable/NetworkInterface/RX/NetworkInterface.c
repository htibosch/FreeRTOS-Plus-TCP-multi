...
NetworkInterface_t * pxRX65_FillInterfaceDescriptor( BaseType_t xNumber,
 ...
 * objects.  See the description in FreeRTOS_Routing.h. */
	NetworkInterface_t * pxFillInterfaceDescriptor( BaseType_t xEMACIndex,
													NetworkInterface_t * pxInterface )
	{
		pxRX65_FillInterfaceDescriptor( xEMACIndex, pxInterface );
	}

#endif /* ( ipconfigCOMPATIBLE_WITH_SINGLE != 0 ) */

NetworkInterface_t * pxRX65_FillInterfaceDescriptor( BaseType_t xEMACIndex,
													 NetworkInterface_t * pxInterface )
{
	static char pcName[ 8 ];

/* This function pxRX65_FillInterfaceDescriptor() adds a network-interface.
